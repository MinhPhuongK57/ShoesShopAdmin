                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php if($arr__cusaccount['status'] == 1) : ?>
                                        <a href="setting__status.php?id_card=<?php echo $arr__cusaccount['id_card']?>" class="btn btn-success">Active</a> <!--<i class="far fa-thumbs-up"></i>-->
                                <?php elseif ($arr__cusaccount['status'] == 2) : ?>
                                        <a href="setting__status.php?id_card=<?php echo $arr__cusaccount['id_card']?>" class="btn btn-danger">Lock</a> <!--<i class="far fa-thumbs-down"></i>-->
                                <?php elseif ($arr__cusaccount['status'] == 0) : ?>
                                        <a href="#" class="btn btn-danger">Deactive</a> <!--<i class="far fa-thumbs-down"></i>-->
                                <?php endif ?>
                            </td>
