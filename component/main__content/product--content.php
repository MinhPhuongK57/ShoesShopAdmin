                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php if($arr__product['status'] == 1):?>
                                            <a href="setting__status.php?id_product=<?php echo $arr__product['id_product']?>" class="btn btn-success">Active</a> <!--<i class="far fa-thumbs-up"></i> -->
                                    <?php else: ?>
                                            <a href="setting__status.php?id_product=<?php echo $arr__product['id_product']?>" class="btn btn-danger">Deactive</a> <!--<i class="far fa-thumbs-down"></i>-->
                                    <?php endif ?>
                                </td>
