                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php if ($arr__bill['status'] == 1) : ?>
                                        <a href="setting__status.php?id_bill=<?php echo $arr__bill['id_bill'] ?>" class="btn btn-success">Active</a>
                                        <!--<i class="far fa-thumbs-up"></i>-->
                                    <?php else : ?>
                                        <a href="setting__status.php?id_bill=<?php echo $arr__bill['id_bill'] ?>" class="btn btn-danger">Deactive</a>
