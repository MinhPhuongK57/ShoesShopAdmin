                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php if ($arr__protype['status'] == 1) : ?>
                                        <a href="setting__status.php?id_producttype=<?php echo $arr__protype['id_producttype'] ?>" class="btn btn-success">Active</a>
                                        <!--<i class="far fa-thumbs-up"></i>-->
                                    <?php else : ?>
                                        <a href="setting__status.php?id_producttype=<?php echo $arr__protype['id_producttype'] ?>" class="btn btn-danger">Deactive</a>
